  ...
  return (
    <div className="flex items-start gap-3">
      <div className="flex flex-col items-center shrink-0">
        <div className="w-6 h-6 rounded-full border border-border bg-bg-600 flex items-center justify-center">
          <span className="font-mono text-2xs text-text-secondary font-semibold">{index}</span>
        </div>
        {!isLast && (
    ...
    <div className="flex flex-col gap-4 px-6 py-6 max-w-3xl mx-auto">
      ...
      <div className="rounded-card border border-border bg-bg-700">
        <div className="border-b border-border px-4 py-2.5">
          <p className="caption">Stage progression</p>
        </div>
      ...
      <p className="text-xs text-text-muted pb-2">
        Evidence-based research governance. Not trading approval.
      </p>
    </div>
  );
}
